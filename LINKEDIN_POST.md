...
Publica `portfolio/cover.png` como primera imagen y agrega de dos a cuatro capturas del dashboard. Sustituye el enlace, etiqueta a XM solo como fuente de datos y evita afirmar que el modelo predice decisiones reales de mercado: es un caso técnico demostrativo.
